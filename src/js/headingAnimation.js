...
export default function headingAnimation() {
    ...
    headers.forEach(header => {
        ...
        if (lineParent.length === 2 && (header.matches('.news__heading, .apartments__heading, .rooms-catalog__heading, .spa-services__heading, .programs__block-heading') || (header.matches('.bath-rest__heading--mobile-centered') && IS_MOBILE))) {
